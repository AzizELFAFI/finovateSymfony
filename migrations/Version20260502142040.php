 ...
 */
final class Version20260502142040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE goal CHANGE id id BIGINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE goal CHANGE id id BIGINT AUTO_INCREMENT NOT NULL');
