...
final class FrontController extends AbstractController
{
    ...
    #[Route('/products', name: 'front_products', methods: ['GET'])]
    ...
    #[Route('/products/{id}', name: 'front_product_detail', methods: ['GET'])]
    ...
    #[Route('/ads', name: 'front_ads', methods: ['GET'])]
    ...
    #[Route('/ads/{id}', name: 'front_ad_detail', methods: ['GET'])]
    ...
    #[Route('/ads/{id}/click', name: 'front_ad_click', methods: ['POST'])]
